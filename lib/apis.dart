...
class BaseApi {
  ...
  String fromMapToFormUrlEncoded(Map<String, dynamic> param) {
    var parts = [];
...
class Api extends BaseApi {
  ...
  Future<Map<String, dynamic>> postToApi(String url, { Map<String, dynamic> postParams }) async {
...
class AuthApi extends BaseApi {
  ...
  AuthApi(this.accessToken, this.configuration): assert(accessToken != null, "Akses token tidak boleh kosong!"), super(configuration);
  ...
  Future<Map<String, dynamic>> postToApi(String url, { Map<String, String> postParameter, Map<String, String> httpHeader }) async {
